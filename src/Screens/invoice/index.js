    ...
    <View style={{ flex: 1, backgroundColor: '#FDF3E8' }}>
      ...
      <ScrollView>
        <View style={{ width: '95%', backgroundColor: '#fff', alignSelf: 'center', marginTop: 10, borderRadius: 6, elevation: 5, marginBottom: 10 }}>
          ...
          <View style={{ width: '90%', borderRadius: 5, borderWidth: 1, borderColor: '#ccc', height: 45, alignSelf: 'center', marginTop: 10 }}>
            <Picker
              style={{ marginTop: -5 }}
              selectionColor={'#555'}
        ...
        <SwipeListView
          ...
          renderItem={(data, rowMap) => (
            <View style={{ backgroundColor: '#fff', width: '100%', alignSelf: 'center', marginBottom: 7, padding: 12 }}>
