...
// create a component
const ReturnDetails = ({ props, route, navigation }) => {
    ...
    <View style={{ flex: 1, backgroundColor: '#FDF3E8' }}>
      ...
      <ScrollView>
        <View style={{ width: '95%', backgroundColor: '#fff', alignSelf: 'center', marginTop: 10, borderRadius: 6, elevation: 5, marginBottom: 10 }}>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: responsiveWidth(4), width: '90%', alignSelf: 'center', alignItems: 'center', marginVertical: 10, marginBottom: 0 }}>
            <Text style={{ fontSize: responsiveFontSize(2), color: '#000', }}> Return Amount</Text>
            <Text style={{ fontSize: responsiveFontSize(2), color: '#000', }}> 9879</Text>
          </View>
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
